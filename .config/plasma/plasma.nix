{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-dbf4e35f-f0c4-43d6-9a9b-37081505e9c4" = [ ];
      "KDE Keyboard Layout Switcher"."Switch to Last-Used Keyboard Layout" = "Meta+Alt+L";
      "KDE Keyboard Layout Switcher"."Switch to Next Keyboard Layout" = "Meta+Alt+K";
      "kaccess"."Toggle Screen Reader On and Off" = "Meta+Alt+S";
      "kcm_touchpad"."Disable Touchpad" = "Touchpad Off";
      "kcm_touchpad"."Enable Touchpad" = "Touchpad On";
      "kcm_touchpad"."Toggle Touchpad" = ["Touchpad Toggle" "Meta+Ctrl+Touchpad Toggle" "Meta+Ctrl+Zenkaku Hankaku,Touchpad Toggle" "Meta+Ctrl+Touchpad Toggle" "Meta+Ctrl+Zenkaku Hankaku,Toggle Touchpad"];
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2025,10,23,17,8,14.227";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."dbf4e35f-f0c4-43d6-9a9b-37081505e9c4" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "dbf4e35f-f0c4-43d6-9a9b-37081505e9c4";
      ...
      "kcminputrc"."Libinput/13284/13591/G-Wolves G-Wolves Fenrir Asym 8K Wireless Mouse-N"."PointerAccelerationProfile" = 1;
      "kcminputrc"."Mouse"."X11LibInputXAccelProfileFlat" = true;
      "kded5rc"."Module-device_automounter"."autoload" = false;
      "kdeglobals"."DirSelect Dialog"."DirSelectDialog Size" = "853,584";
      "kdeglobals"."DirSelect Dialog"."Splitter State" = "\x00\x00\x00\xff\x00\x00\x00\x01\x00\x00\x00\x02\x00\x00\x00\xb1\x00\x00\x02\xa8\x00\xff\xff\xff\xff\x01\x00\x00\x00\x01\x00";
      ...
      "kwinrc"."Activities/LastVirtualDesktop"."dbf4e35f-f0c4-43d6-9a9b-37081505e9c4" = "2f0547ae-79e1-4351-b0d9-c645286bb817";
      "kwinrc"."Desktops"."Id_1" = "2f0547ae-79e1-4351-b0d9-c645286bb817";
      "kwinrc"."Desktops"."Id_2" = "e276f08e-b45a-46bd-b0ca-bca22bb3b87e";
      "kwinrc"."Desktops"."Number" = 2;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Effect-overview"."BorderActivate" = 9;
      "kwinrc"."Plugins"."mouseclickEnabled" = true;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling/5b193bda-0770-5065-8a16-676085ae269f"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/83ad5721-be29-5be6-af45-3646523a9c5c"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Xwayland"."Scale" = 1;
      "kwinrulesrc"."024f0958-3013-4cad-9710-a7d4005823ba"."Description" = "Window settings for steam_app_1422450 Deadlock";
      "kwinrulesrc"."024f0958-3013-4cad-9710-a7d4005823ba"."acceptfocus" = true;
      "kwinrulesrc"."024f0958-3013-4cad-9710-a7d4005823ba"."acceptfocusrule" = 2;
      "kwinrulesrc"."024f0958-3013-4cad-9710-a7d4005823ba"."clientmachine" = "localhost";
      "kwinrulesrc"."024f0958-3013-4cad-9710-a7d4005823ba"."disableglobalshortcutsrule" = 2;
      "kwinrulesrc"."024f0958-3013-4cad-9710-a7d4005823ba"."fpplevelrule" = 2;
      "kwinrulesrc"."024f0958-3013-4cad-9710-a7d4005823ba"."fsplevel" = 4;
      "kwinrulesrc"."024f0958-3013-4cad-9710-a7d4005823ba"."fsplevelrule" = 2;
      "kwinrulesrc"."024f0958-3013-4cad-9710-a7d4005823ba"."ignoregeometry" = true;
      "kwinrulesrc"."024f0958-3013-4cad-9710-a7d4005823ba"."ignoregeometryrule" = 2;
      "kwinrulesrc"."024f0958-3013-4cad-9710-a7d4005823ba"."layerrule" = 2;
      "kwinrulesrc"."024f0958-3013-4cad-9710-a7d4005823ba"."noborder" = true;
      "kwinrulesrc"."024f0958-3013-4cad-9710-a7d4005823ba"."noborderrule" = 2;
      "kwinrulesrc"."024f0958-3013-4cad-9710-a7d4005823ba"."opacityactiverule" = 2;
      "kwinrulesrc"."024f0958-3013-4cad-9710-a7d4005823ba"."strictgeometryrule" = 2;
      "kwinrulesrc"."024f0958-3013-4cad-9710-a7d4005823ba"."title" = "Deadlock";
      "kwinrulesrc"."024f0958-3013-4cad-9710-a7d4005823ba"."titlematch" = 1;
      "kwinrulesrc"."024f0958-3013-4cad-9710-a7d4005823ba"."types" = 1;
      "kwinrulesrc"."024f0958-3013-4cad-9710-a7d4005823ba"."wmclass" = "steam_app_1422450";
      "kwinrulesrc"."024f0958-3013-4cad-9710-a7d4005823ba"."wmclassmatch" = 1;
      "kwinrulesrc"."4fc583d4-1fed-43aa-9d01-31d81790475e"."Description" = "Window settings for CrossOver";
      "kwinrulesrc"."4fc583d4-1fed-43aa-9d01-31d81790475e"."clientmachine" = "localhost";
      "kwinrulesrc"."4fc583d4-1fed-43aa-9d01-31d81790475e"."layer" = "overlay";
      "kwinrulesrc"."4fc583d4-1fed-43aa-9d01-31d81790475e"."layerrule" = 2;
      "kwinrulesrc"."4fc583d4-1fed-43aa-9d01-31d81790475e"."title" = "CrossOver";
      "kwinrulesrc"."4fc583d4-1fed-43aa-9d01-31d81790475e"."types" = 1;
      "kwinrulesrc"."4fc583d4-1fed-43aa-9d01-31d81790475e"."windowrole" = "browser-window";
      "kwinrulesrc"."4fc583d4-1fed-43aa-9d01-31d81790475e"."windowrolematch" = 1;
      "kwinrulesrc"."4fc583d4-1fed-43aa-9d01-31d81790475e"."wmclass" = "crossover CrossOver";
      "kwinrulesrc"."4fc583d4-1fed-43aa-9d01-31d81790475e"."wmclasscomplete" = true;
      "kwinrulesrc"."4fc583d4-1fed-43aa-9d01-31d81790475e"."wmclassmatch" = 1;
      "kwinrulesrc"."7fb2eee7-4cee-411f-9f79-b7f995155d04"."Description" = "Window settings for steam_app_2073850 THE FINALS";
      "kwinrulesrc"."7fb2eee7-4cee-411f-9f79-b7f995155d04"."clientmachine" = "localhost";
      "kwinrulesrc"."7fb2eee7-4cee-411f-9f79-b7f995155d04"."noborder" = true;
      "kwinrulesrc"."7fb2eee7-4cee-411f-9f79-b7f995155d04"."noborderrule" = 2;
      "kwinrulesrc"."7fb2eee7-4cee-411f-9f79-b7f995155d04"."position" = "0,0";
      "kwinrulesrc"."7fb2eee7-4cee-411f-9f79-b7f995155d04"."positionrule" = 2;
      "kwinrulesrc"."7fb2eee7-4cee-411f-9f79-b7f995155d04"."size" = "1920,1080";
      "kwinrulesrc"."7fb2eee7-4cee-411f-9f79-b7f995155d04"."sizerule" = 2;
      "kwinrulesrc"."7fb2eee7-4cee-411f-9f79-b7f995155d04"."title" = "THE FINALS";
      "kwinrulesrc"."7fb2eee7-4cee-411f-9f79-b7f995155d04"."titlematch" = 1;
      "kwinrulesrc"."7fb2eee7-4cee-411f-9f79-b7f995155d04"."types" = 1;
      "kwinrulesrc"."7fb2eee7-4cee-411f-9f79-b7f995155d04"."wmclass" = "steam_app_2073850";
      "kwinrulesrc"."7fb2eee7-4cee-411f-9f79-b7f995155d04"."wmclassmatch" = 1;
      "kwinrulesrc"."General"."count" = 3;
      "kwinrulesrc"."General"."rules" = "024f0958-3013-4cad-9710-a7d4005823ba,4fc583d4-1fed-43aa-9d01-31d81790475e,7fb2eee7-4cee-411f-9f79-b7f995155d04";
      "plasma-localerc"."Formats"."LANG" = "en_GB.UTF-8";
      "plasmanotifyrc"."Applications/DigitalZen"."Seen" = true;
    ...
    dataFile = {
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///home/zitchaden/.config/obs-studio/user.ini";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 290;
