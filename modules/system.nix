  ...
  environment.systemPackages = with pkgs; [
    ...
    (pkgs.writeScriptBin "cognito-omnibar" ''
      ...
      declare -A cmd_definitions=(
          ...
          ["restart-xmobar"]="pkill xmobar 2>/dev/null || true; sleep 1; mkfifo /tmp/xmobar-input 2>/dev/null || true; xmobar /etc/xmobar/xmobarrc < /tmp/xmobar-input & && notify-send 'Debug' 'Xmobar restarted'"
